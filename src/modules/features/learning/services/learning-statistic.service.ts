...
export class LearningStatisticService {
    ...
    async getStatsForUser(userId: string) {
        ...
        const accessQuery = this.learningAccessService.getQueryLearningAccess(userInfo.participant_profile);
    ...
    private async getCoachingStats(userId: string, profile: any) {
        const accessQuery = this.learningAccessService.getCoachingAccessQuery(profile);
